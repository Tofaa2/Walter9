...
/*     */   @Property(type = Property.Type.BOOLEAN, name = "Auto Clicker")
...
/*  50 */   public static int autoClickerCps = 100;
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*  58 */   public static int autoClickerMode = 0;
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/*     */   @Property(type = Property.Type.BOOLEAN, name = "Summons Features")
...
/*     */ 
/*     */   
/*     */   @Property(type = Property.Type.BOOLEAN, name = "Click Through Summons", parent = "Summons Features")
...
/*     */ 
/*     */   
/*     */   @Property(type = Property.Type.BOOLEAN, name = "Teleport w/ Anything")
...
/*     */ 
/*     */   
/*     */   @Property(type = Property.Type.BOOLEAN, name = "Keybinds")
...
/*     */ 
/*     */   
/*     */   @Property(type = Property.Type.BOOLEAN, name = "Item Hotkeys", parent = "Keybinds")
...
/*     */ 
/*     */   
/*     */   @Property(type = Property.Type.BOOLEAN, name = "Ice Spray", parent = "Item Hotkeys")
...
/*     */ 
/*     */   
/*     */   @Property(type = Property.Type.BOOLEAN, name = "Rogue Sword", parent = "Item Hotkeys")
...
/*     */ 
/*     */   
/*     */   @Property(type = Property.Type.BOOLEAN, name = "Power Orb", parent = "Item Hotkeys")
...
/*     */ 
/*     */   
/*     */   @Property(type = Property.Type.BOOLEAN, name = "Weird Tuba", parent = "Item Hotkeys")
...
/*     */ 
/*     */   
/*     */   @Property(type = Property.Type.BOOLEAN, name = "Gyrokinetic Wand", parent = "Item Hotkeys")
...
/*     */ 
/*     */   
/*     */   @Property(type = Property.Type.BOOLEAN, name = "Pigman Sword", parent = "Item Hotkeys")
...
/*     */ 
/*     */   
/*     */   @Property(type = Property.Type.BOOLEAN, name = "Healing Wand", parent = "Item Hotkeys")
...
/*     */ 
/*     */   
/*     */   @Property(type = Property.Type.BOOLEAN, name = "Fishing Rod", parent = "Item Hotkeys")
...
/*     */ 
/*     */   
/*     */   @Property(type = Property.Type.BOOLEAN, name = "Block Abilities")
...
/*     */ 
/*     */   
/*     */   @Property(type = Property.Type.BOOLEAN, name = "Cells Alignment", parent = "Block Abilities")
...
/*     */ 
/*     */   
/*     */   @Property(type = Property.Type.BOOLEAN, name = "Giant's Slam", parent = "Block Abilities")
...
/*     */ 
/*     */   
/*     */   @Property(type = Property.Type.BOOLEAN, name = "Valkyrie Wither Impact", parent = "Block Abilities")
...
/*     */ 
/*     */   
/*     */   @Property(type = Property.Type.BOOLEAN, name = "Dungeon Map (WIP)", credit = "based on IllegalMap by UnclaimedBloom6")
...
/*     */ 
/*     */   
/*     */   @Property(type = Property.Type.BOOLEAN, name = "Show Run Information", parent = "Dungeon Map (WIP)")
...
/*     */ 
/*     */   
/* 278 */   public static int witherDoorColor = 0;
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/*     */   @Property(type = Property.Type.BOOLEAN, name = "Assume Spirit Pet", parent = "Dungeon Map (WIP)")
...
/*     */ 
/*     */   
/*     */   @Property(type = Property.Type.BOOLEAN, name = "Announce Score in Chat", parent = "Dungeon Map (WIP)")
...
/* 304 */   public static int announceScoreNumber = 300;
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/* 312 */   public static int announceScoreChat = 0;
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/*     */   @Property(type = Property.Type.NUMBER, name = "Horizontal Offset", parent = "Dungeon Map (WIP)", suffix = "px", step = 10)
/* 321 */   public static int mapXOffset = 10;
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/*     */   @Property(type = Property.Type.NUMBER, name = "Vertical Offset", parent = "Dungeon Map (WIP)", suffix = "px", step = 10)
/* 330 */   public static int mapYOffset = 10;
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/*     */   @Property(type = Property.Type.NUMBER, name = "Scale", parent = "Dungeon Map (WIP)", suffix = "%", step = 10, min = 50, max = 150)
/* 341 */   public static int mapScale = 80;
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/*     */   @Property(type = Property.Type.NUMBER, name = "Background Opacity", parent = "Dungeon Map (WIP)", max = 100, step = 10, suffix = "%")
/* 351 */   public static int mapBackgroundOpacity = 50;
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/*     */   @Property(type = Property.Type.SELECT, name = "Significant Room Name Style", parent = "Dungeon Map (WIP)", options = {"Short", "Full", "None"})
/* 366 */   public static int significantRoomNameStyle = 0;
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 374 */   public static int mapCheckmarkStyle = 0;
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */   
/*     */   @Property(type = Property.Type.BOOLEAN, name = "Auto Close Chests")
...
/*     */ 
/*     */   
/*     */   @Property(type = Property.Type.BOOLEAN, name = "Show Hidden Mobs")
...
/*     */ 
/*     */   
/*     */   @Property(type = Property.Type.BOOLEAN, name = "Shadow Assassins", parent = "Show Hidden Mobs")
...
/*     */ 
/*     */   
/*     */   @Property(type = Property.Type.BOOLEAN, name = "Fels", parent = "Show Hidden Mobs")
...
/*     */ 
/*     */   
/*     */   @Property(type = Property.Type.BOOLEAN, name = "Ghosts", parent = "Show Hidden Mobs")
...
/*     */ 
/*     */   
/*     */   @Property(type = Property.Type.BOOLEAN, name = "Stealthy Blood Mobs", parent = "Show Hidden Mobs")
...
/*     */ 
/*     */   
/*     */   @Property(type = Property.Type.BOOLEAN, name = "Gemstone ESP")
...
/* 461 */   public static int gemstoneRadius = 15;
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/*     */   @Property(type = Property.Type.BOOLEAN, name = "Cat Girls", credit = "I was paid to add this, ok?")
...
/*     */ 
/*     */   
/*     */   @Property(type = Property.Type.SELECT, name = "Cat-Mode", parent = "Cat Girls", options = {"Girls", "Boys", "Bisexual"})
/* 533 */   public static int catGirlsMode = 0;
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */   
/*     */   @Property(type = Property.Type.BOOLEAN, name = "Auto Terminals", credit = "by 0Kelvin_")
...
/*     */ 
/*     */   
/*     */   @Property(type = Property.Type.BOOLEAN, name = "Maze", parent = "Auto Terminals")
...
/*     */ 
/*     */   
/*     */   @Property(type = Property.Type.BOOLEAN, name = "Click in Order", parent = "Auto Terminals")
...
/*     */ 
/*     */   
/*     */   @Property(type = Property.Type.BOOLEAN, name = "Correct the Panes", parent = "Auto Terminals")
...
/*     */ 
/*     */   
/*     */   @Property(type = Property.Type.BOOLEAN, name = "Name Starts With", parent = "Auto Terminals")
...
/*     */ 
/*     */   
/*     */   @Property(type = Property.Type.BOOLEAN, name = "Color", parent = "Auto Terminals")
...
/*     */ 
/*     */   
/*     */   @Property(type = Property.Type.BOOLEAN, name = "Pingless", parent = "Auto Terminals")
...
/* 594 */   public static int terminalClickDelay = 100;
/*     */ }


/* Location:              C:\Users\amine\Desktop\ShadyAddons-2.1.0-pre2.jar!\cheaters\get\banned\config\Config.class
